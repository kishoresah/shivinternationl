                            ...
                            <div className="col-md-12">
                                <div className="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                    <div className="col p-4 d-flex flex-column position-static">
                                        ...
                                        <h3 className="mb-0"><i className="fa fa-eye" aria-hidden="true"></i> Our Vision
                                        </h3>
                        ...
                        <div className="row mb-2">
                            {visionData && visionData.map((el) => (
                                <div className="col-md-6">
                                    ...
                                    <div className="card row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 min-h-175-px position-relative">
