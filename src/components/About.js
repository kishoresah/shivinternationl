                        ...
                        <div className="col-sm-8 mx-auto">
                            <div className="text-middle">
                                <div className="text">
                                    ...
                                    <p> <span>HNRM Tele Construction Pvt. Ltd. </span> is a specialized expansion focusing on construction work related to electrical installations. Additionally, HNRM is an authorized supplier and service provider for railway signaling and telecom equipment.
